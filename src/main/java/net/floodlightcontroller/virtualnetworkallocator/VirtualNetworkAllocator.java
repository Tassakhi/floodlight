...
//		test = in.nextLine();
		...
		for(int i = 2; i < 41; i++) {
			...
			try {
			     File file = new File("/home/sheenroot/Downloads/zip/dan/results/results_" + i + "_alloc_time.txt");
			...
			myPW = null;
			try {
			     File file = new File("/home/sheenroot/Downloads/zip/dan/results/results_" + i + "_hop_count.txt");
			     FileWriter fw = new FileWriter(file, true);
			     myPW = new PrintWriter(fw);    
			} catch (IOException e) {
				e.printStackTrace();
			...
			try {
			     File file = new File("/home/sheenroot/Downloads/zip/dan/results/results_" + i + "_number_of_proc_requests.txt");
			     FileWriter fw = new FileWriter(file, true);
			...
			try {
			     File file2 = new File("/home/sheenroot/Downloads/zip/dan/results/results_" + i + "_server_util.txt");
			...
			try {
			     File file3 = new File("/home/sheenroot/Downloads/zip/dan/results/results_" + i + "_network_util.txt");
	...
	public void initNetwork() {
		try {
			File fXmlFile = new File(
					"/home/sheenroot/Downloads/zip/dan/physical_network.xml");
	...
	public boolean processVirtualNetwork(String fileName) {
		...
		try {
			File myXmlFile = new File(
					"/home/sheenroot/Downloads/zip/dan/" + fileName + ".xml");
